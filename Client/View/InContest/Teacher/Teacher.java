package pbl4.Client.View.InContest.Teacher;
...
import pbl4.Client.Controller.InContest.Teacher.TeacherController;
...
public class Teacher extends JFrame {
	...
	public Teacher(TeacherController controller) {
	...
	public void addKeyLog(int studentNum, String start, String keys) {
		String cameraText = cameraScreens.get(studentNum * 2).getText();
		int i = cameraText.indexOf(' ');
		int j = cameraText.indexOf(' ', i + 1);
		String msg = start + " " + studentNum + ". " + cameraText.substring(i + 1, j) + " has typed: " + keys;
		keyPn.addText(msg);
	}
}
